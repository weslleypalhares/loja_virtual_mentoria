...
public class TarefaAutomatizadaService {
	...
	@Scheduled(cron = "0 0 11 * * *", zone = "America/Sao_Paulo")/*Vai rodar todos os dias as 11 hr da manhã pelo horário de brasilia*/
	public void notificarUserTrocaSenha() throws UnsupportedEncodingException, MessagingException, InterruptedException {
		...
		for (Usuario usuario : usuarios) {
			...
			msg.append("Troque a sua senha da loja virtual do Alex - JDEV Treinamento");

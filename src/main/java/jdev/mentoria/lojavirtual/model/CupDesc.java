...
public class CupDesc implements Serializable{
	...
	public Date getDatValidadeCupom() {
		return datValidadeCupom;
	}

	public void setDatValidadeCupom(Date datValidadeCupom) {
		this.datValidadeCupom = datValidadeCupom;
	}
